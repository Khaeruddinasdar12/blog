...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark"><i class="fa fa-newspaper"></i> Blog</h1>
			</div><!-- /.col -->
			<div class="col-sm-6">
		...
		<div class="row">
			...
			<div class="col-12">
				...
				<div class="alert alert-success alert-dismissible fade show" role="alert">
					<strong>Berhasil Mengubah Blog !</strong><a href="{{route('blog.show', session('success'))}}" class="alert-anchor">Preview</a>
				...
				<div class="card card-secondary card-outline">
					<form method="post" enctype="multipart/form-data" action="{{route('blog.update', ['id' => $data->id])}}">
						<div class="card-header">
							<h2 class="card-title"><i class="fa fa-newspaper"></i> Edit Blog</h2>
								...
								<div class="col-6">
									...
									<div class="form-group">
										<select class="form-control" name="kategori">
											@foreach($ktg as $ktgr)
											<option value="{{$ktgr->id}}" @if($ktgr->id == $data->category_id) selected @endif>{{$ktgr->nama}}</option>
											@endforeach
										</select>
									</div>
								</div>
