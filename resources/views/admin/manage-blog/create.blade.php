		...
		<div class="row">
			...
			<div class="col-12">
				...
				<div class="alert alert-success alert-dismissible fade show" role="alert">
					<strong>Berhasil Menambah Berita !</strong> <a href="{{route('blog.edit', session('success'))}}" class="alert-anchor">Sunting</a> atau <a href="{{route('blog.show', session('success'))}}" class="alert-anchor">Preview</a>
